...
From this two-panel plot,it shows that the average maximum temperature of January is lower than July. The average maximum temperatures of January and July across years did not show absolutely increase. It seems to exist a outline in Jan.2004, and a outline in 1988. But the outlines need to be verified by statistical calculation.
